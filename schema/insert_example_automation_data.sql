INSERT INTO automation(a_name, created, autom_mode, max_instances, script, error) 
VALUES ('test_automation_123', CURRENT_TIMESTAMP, 0, 1, 'test_automation_123.py', 0);
...
SELECT a.a_name, e.e_name, i.i_name, p_role, position 
