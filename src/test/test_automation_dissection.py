...
from environment_package.ha_automation.home_assistant_const import (
    CONF_ABOVE, CONF_ALLOWED_METHODS, CONF_AT, CONF_ATTRIBUTE, CONF_BELOW,
    CONF_COMMAND, CONF_DEVICE_ID, CONF_DOMAIN, CONF_ENTITY_ID, CONF_EVENT,
    CONF_EVENT_CONTEXT, CONF_EVENT_DATA, CONF_EVENT_TYPE, CONF_FOR, CONF_FROM,
    CONF_LOCAL, CONF_NOFITY_ID, CONF_NOT_FROM, CONF_NOT_TO, CONF_NUMERIC_STATE,
    CONF_OFFSET, CONF_PAYLOAD, CONF_PLATFORM, CONF_QOS, CONF_SOURCE,
    CONF_STATE, CONF_TO, CONF_TYPE, CONF_UPDATE_TYPE, CONF_VALUE_TEMPLATE,
    CONF_WEBHOOK_ID, CONF_ZONE, HOURS, MINUTES, SECONDS, TAG_ID)
