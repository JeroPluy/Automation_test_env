...
class CTkTable(customtkinter.CTkFrame):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.header_color = (
            customtkinter.ThemeManager.theme["CTkTable"]["header_color"]
            if header_color is None
            else header_color
        )
        self.header_text_color = customtkinter.ThemeManager.theme["CTkButton"][
            "text_color"
        ]
        ...
        self.hover_color = (
            customtkinter.ThemeManager.theme["CTkSwitch"]["progress_color"]
        ...
        if self._get_appearance_mode() == "light":
            ...
            self.fg_color2 = customtkinter.ThemeManager.theme["CTkFrame"][
                "top_fg_color"
            ]
        else:
            self.fg_color = customtkinter.ThemeManager.theme["CTkFrame"]["fg_color"]
    ...
    def draw_table(self, **kwargs):
        ...
        for i in range(self.rows):
            for j in range(self.columns):
                ...
                if i == 0:
                    args["text_color"] = self.header_text_color
                    args["font"] = self.header_font
                else:
                ...
                if self.write:
                    ...
                    if i == 0 or (j == 0 and self.header_col):
                        anchor = args["justify"]
                        if anchor == "center":
                            anchor = "c"
                        elif anchor == "left":
                        ...
                        if self.frame[i, j]._text_label is not None and self.wrap:
                            self.frame[i, j]._text_label.config(
                                wraplength=self.wraplength
                            )

                        self.frame[i, j].grid(column=j, row=i, sticky="nsew")
                        ...
                        self.frame[i, j] = customtkinter.CTkEntry(
                            self.inside_frame, corner_radius=8, **args
                        )
    ...
    def update_data(self):
        ...
        for i in self.frame:
            if self.write and (i[0] != 0 and (i[1] != 0 if self.header_col else True)):
    ...
    def get_selected_rows(self):
        ...
        if self.multi_select:
            ...
            for row in self.selected_rows:
                selected_rows.append(self.get_row(row))
    ...
    def get_selected_columns(self):
        ...
        if self.multi_select:
            ...
            for column in self.selected_columns:
                selected_columns.append(self.get_column(column))
        else:
            return None
